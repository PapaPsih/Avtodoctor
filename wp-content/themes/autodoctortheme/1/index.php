                        ...
                        <div class="new-brand__row">
                            <div class="col-wrap col-wrap_50">
                                ...
                                <div class="col col_50">
                                    <div class="col__i">
                                        <div class="img">
                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/static/img/content/news-image-sample0.png" alt="logo" />
                                        </div>
                                        <div class="wrap-text">
                                            <a href="#">
                                                <div class="text">
                                ...
                                <div class="col col_50">
                                    <div class="col__i">
                                        <div class="img">
                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/static/img/content/news-image-sample.png" alt="logo" />
                                        </div>
                                        <div class="wrap-text">
                                            <a href="#">
                                                <div class="text">
                            ...
                            <div class="col-wrap col-wrap_50">
                                ...
                                <div class="col col_50">
                                    <div class="img">
                                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/static/img/content/news-image-sample1.png" alt="logo" />
                                    </div>
                                    <div class="wrap-text">
                                        <a href="#">
                                            <div class="text">
                ...
                <div class="wrap-center">
                    <div class="footer-main__row">
                        <div class="col col_25">
                            ...
                            <div class="info">
                                <p>г. Одесса, ул. Гаркавого (Житомирская), 46</p>
                        ...
                        <div class="col col_25">
                            ...
                            <div class="info ">
                                <a href="#" class="link-i">Рулевые рейки</a>
                                <a href="#" class="link-i">Тормоза</a>
                                <a href="#" class="link-i">Подвеска</a>
                            </div>
                        </div>
                        <!-- col end-->
                        <div class="col col_25">
                            ...
                            <div class="info">
                                <a href="#" class="logo-footer">
                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/static/img/content/logo-footer.png" alt="logo" />
                                </a>
                                <p>
                                    <b>Autoforce.com</b>— оптовый онлайн-магазин автозапчастей</p>
                            </div>
                        </div>
                        <!-- col end-->
                    </div>
                    <!-- footer-main__row end-->
                    <div class="footer-main__i">
                        <div class="copy">
                            <span>Autodoctor© 2015. Все права защищены.</span>
                        </div>
                        <div class="mab">
                            <span>Made by Telpis Georgiy</span>
                        </div>
                    </div>
                </div>
            </footer>
