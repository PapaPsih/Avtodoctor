...
<head>
    ...
    <link href="<?php echo esc_url( get_template_directory_uri() ); ?>/static/css/mainnpe7firudi.min.css" rel="stylesheet" type="text/css">
    <link rel="icon" type="image/png" href="fav.png">
    <!--[if lt IE 9]>
    <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/html5shiv-3.7.2.min.js"></script>
    <![endif]-->
</head>
...
<div class="our">
    <div class="cup">
        <div class="cup_i">
            <div class="img">
                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/static/img/content/cap.png" alt="logo" />
            </div>
            <div class="title">
                <span>Автодоктор</span>
            </div>
            <p>Сайт находится на стадии разработки. Вы можете узнать первым об открытии, оставив свою почту</p>

            <form class="form-post" action="//avtodoctor.us12.list-manage.com/subscribe/post?u=2bd2aba0c227c79a185be52d9&amp;id=83e50c78bd" method="post">
                <input type="text" name="EMAIL" class="inp" placeholder="E-mail" />
                <a href="#" class="btn btn_light">Отправить</a>
            </form>
        </div>
    </div>
